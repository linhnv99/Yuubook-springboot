		...
		<div class="container-fluid">
			<ul>
				...
				<li><img src="${path }/images/right-arrow.png"
					class="img-fluid"><a
					href="${path }/product/cate/${parentCateSelected.id}">${parentCateSelected.name }</a></li>
				<c:if test="${not empty CATALOG_SELECTED }">
					<li><img src="${path }/images/right-arrow.png"
						class="img-fluid"><a
						href="${path }/product/cate/${CATALOG_SELECTED.id}">${CATALOG_SELECTED.name }</a></li>
				</c:if>
			</ul>
		</div>
	</div>
											...
											<c:forEach items="${category.subCategories }" var="subCate">
												<c:if test="${subCate.status }">
													<li
														...
														href="${path }/product/cate/${subCate.id}">${subCate.name }</a></li>
												</c:if>
											</c:forEach>
										</c:if>
									</c:forEach>
							...
							<div class="mainbox2-content" id="mainbox2-content">
								...
								<div class="box-sort">
									...
									<div class="sort-by">
										...
										<div class="sort-tmp">
											<a class="${SORT == 'newest' ? 'active' : '' }" href="${path }/product/cate/${CATALOG_SELECTED.id}?sort=newest">Mới nhất</a>
											<a class="${SORT == 'az' ? 'active' : '' }" href="${path }/product/cate/${CATALOG_SELECTED.id}?sort=az">A đến Z</a>
											<a class="${SORT == 'za' ? 'active' : '' }" href="${path }/product/cate/${CATALOG_SELECTED.id}?sort=za">Z đến A</a>
											<a class="${SORT == 'minmax' ? 'active' : '' }" href="${path }/product/cate/${CATALOG_SELECTED.id}?sort=minmax">Giá thấp nhất</a>
											<a class="${SORT == 'maxmin' ? 'active' : '' }" href="${path }/product/cate/${CATALOG_SELECTED.id}?sort=maxmin">Giá cao nhất</a>
										</div>
									</div>
								</div>
							...
							<div class="pagination">
								<ul>
									<c:if test="${currentPage > 1 }">
										<li><a
											href="${path }/product/cate/${CATALOG_SELECTED.id}?${sortParam }page=${currentPage - 1}"><img
												src="${path}/images/left-arrow.png" alt=""></a></li>
									</c:if>

									<c:forEach var="i" begin="1" end="${totalPages }">
										<li><a
											href="${path }/product/cate/${CATALOG_SELECTED.id}?${sortParam }page=${i}"
