								...
								<div class="row summary-cate">
									...
									<div class="col-5">
										...
										<div class="box-confirm">
											...
											<p>
												Ngày tạo: <span><fmt:parseDate value="${order.buyDate }" type="both" pattern="yyyy-MM-dd'T'HH:mm:ss" var="myDate"></fmt:parseDate>
																	<fmt:formatDate value="${myDate }" pattern="dd-MM-yyyy HH:mm:ss"/></span>
											</p>
										</div>
									</div>
								</div>
