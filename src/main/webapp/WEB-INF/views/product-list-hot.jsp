    ...
    <div class="container-fluid">
        <ul>
            ...
            <li><img src="${path }/images/right-arrow.png"
                     class="img-fluid"><a
                    href="${path }/product/hot"> Kho sách hot</a></li>
        </ul>
    </div>
</div>
<!-- main -->
                        ...
                        <div class="page-category-content">
                            ...
                            <ul>
                                <c:forEach items="${categories }" var="category">
                                    ...
                                    <c:if test="${category.parentId == null && category.status}">
                                        <li><a href="${path }/product/cate/${category.id}"
                                        ...
                                        <c:if test="${category.subCategories.size() > 0 }">
                                            <c:forEach items="${category.subCategories }" var="subCate">
                                                <c:if test="${subCate.status }">
                                                    <li class="pl-5">
                                                        <a href="${path }/product/cate/${subCate.id}"
                                                           style="font-size: 14px">${subCate.name }</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
                                        </c:if>
                        ...
                        <div class="sort-by">
                            ...
                            <div class="sort-tmp">
                                <a class="${SORT == 'newest' ? 'active' : '' }"
                                   href="${path }/product/hot?sort=newest">Mới nhất</a>
                                <a class="${SORT == 'az' ? 'active' : '' }"
                                   href="${path }/product/hot?sort=az">A đến Z</a>
                                <a class="${SORT == 'za' ? 'active' : '' }"
                                   href="${path }/product/hot?sort=za">Z đến A</a>
                                <a class="${SORT == 'minmax' ? 'active' : '' }"
                                   href="${path }/product/hot?sort=minmax">Giá thấp nhất</a>
                                <a class="${SORT == 'maxmin' ? 'active' : '' }"
                                   href="${path }/product/hot?sort=maxmin">Giá cao nhất</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pagination">
                        <ul>
                            <c:if test="${currentPage > 1 }">
                                <li><a
                                        href="${path }/product/hot?${sortParam }page=${currentPage - 1}"><img
                                        src="${path}/images/left-arrow.png" alt=""></a></li>
                            </c:if>

                            <c:forEach var="i" begin="1" end="${totalPages }">
                                <li><a
                                        href="${path }/product/hot?${sortParam }page=${i}"
