...
public class JPAConf {
	...
	private Environment env;//use to get profiles and properties of the application environment
	...
	protected DataSource dataSource() {
		...
		// HikariConfig giúp tạo connection pool(tạo sẵn 100db trong database(mysql tối đa 200db))
	}
	@Bean
	protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("com.devpro.yuubook");
